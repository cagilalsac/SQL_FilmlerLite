create procedure spFilmRaporOlustur @raporAdi varchar(200), @filmAdi varchar(300) = 'Avatar'
as
...
begin
	...
	begin
		...
		begin
			...
			select @karZarar = ISNULL(Gisesi - Maliyeti,0), @turSayisi = COUNT(TurAdi) from vFilmDetayTur 
			where Id = @filmId
